...
/** Legacy-compatible permission matrix presented by the Access Control module. */
...
> = {
  ...
  GENERAL_MANAGER: {
    ...
    permissions: {
      Dashboard: PERM.full,
      Documents: PERM.crud,
      'Records Management': [true, false, true, true, true, false, true],
      Templates: PERM.crud,
  ...
  HOD: {
    ...
    permissions: {
      Dashboard: PERM.readExport,
      Documents: PERM.crud,
      'Records Management': [false, false, true, false, true, false, false],
